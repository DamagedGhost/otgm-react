        ...
        <div>
            <aside className="d-flex flex-column justify-content-between vh-100" id="sidebar">
                <div>
                    ...
                    <div classname="flex-grow-1 border-top my-3 pt-3" id="admin-nav-top">
                    <nav classname="nav flex-column mb-3">
                <ul class="nav flex-column">
                    <li id="li" class="nav-item nav-link d-flex align-items-center gap-2">
                    ...
                    <a id="option" class="nav-link text-white" href="#" onclick="window.location.href='/OTGM/Admin/home.html'">Dashboard</a></li>
                    <li id="li" class="nav-item nav-link d-flex align-items-center gap-2">
                    ...
                    <a id="option" class="nav-link text-white" href="#">Ordenes</a></li>
                    <li id="li" class="nav-item nav-link d-flex align-items-center gap-2">
                    ...
                    <a id="option" class="nav-link text-white" href="#" onclick="window.location.href='/OTGM/Admin/Productos-Admin/producto.html'">Inventario</a></li>
                    <li id="li" class="nav-item nav-link d-flex align-items-center gap-2">
                    ...
                    <a id="option" class="nav-link text-white" href="#">Reportes</a></li>
                    <li id="li" class="nav-item nav-link d-flex align-items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                        <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
                        </svg>
                    <a id="option" class="nav-link text-white" href="#" onclick="window.location.href='/OTGM/Admin/Usuarios/usuario.html'">Usuarios</a></li>
                    <li id="li" class="nav-item nav-link d-flex align-items-center gap-2">
                    ...
                    <a id="option" class="nav-link text-white" href="#">Clientes</a></li>
                </ul>
                    </nav>
                    </div>
                    <div classname="flex-grow-1 border-bottom my-3 pt-3" id="admin-nav-bottom">
                ...
                <ul class="nav flex-column">
                    ...
                    <a class="nav-link text-white" href="#">Configuración</a></li>
                    <li id="li" class="nav-item nav-link d-flex align-items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                        <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
                        <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5"/>
                        </svg>                    
                    <a class="nav-link text-white" href="#">Perfil</a></li>
                    <li id="li" class="nav-item nav-link d-flex align-items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
                        </svg>    
                    <a class="nav-link text-white" href="#">Buscar</a></li>
                    <li id="li" class="nav-item nav-link d-flex align-items-center gap-2">
                    ...
                    <a class="nav-link text-white" href="#">Ayuda</a></li>
                </ul>
                    </nav>
                    </div>
                    <div classname="d-flex align-items-center p-3" id="admin-user">
                    <img src="/OTGM/Admin/user-icon.svg" alt="Icono de usuario" classname="rounded-circle me-2" width="{40}" height="{40}" onerror="this.style.display='none'" />
                    <div classname="d-flex flex-column">
                        <strong classname="fw-bold">Nombre Usuario</strong>
